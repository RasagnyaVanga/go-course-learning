...
const file_helloworld_helloworld_proto_rawDesc = "" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage2\x97\x01\n" +
	"\aGreeter\x12?\n" +
	"\bSayHello\x12\x18.helloworld.HelloRequest\x1a\x19.helloworld.HelloResponse\x12K\n" +
	"\x12SayHelloRepetetive\x12\x18.helloworld.HelloRequest\x1a\x19.helloworld.HelloResponse0\x01B\x1cZ\x1agRPC_helloworld/helloworldb\x06proto3"
...
var file_helloworld_helloworld_proto_depIdxs = []int32{
	...
	0, // 1: helloworld.Greeter.SayHelloRepetetive:input_type -> helloworld.HelloRequest
	1, // 2: helloworld.Greeter.SayHello:output_type -> helloworld.HelloResponse
	1, // 3: helloworld.Greeter.SayHelloRepetetive:output_type -> helloworld.HelloResponse
