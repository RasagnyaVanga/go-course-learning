...
//
//	mockgen -destination=mock_cars.go -package=mock_practice -source=cars.go
//
...
func (mr *MockCARMockRecorder) EngineCheck(arg0, arg1 any) *gomock.Call {
...
func (mr *MockCARMockRecorder) Start(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
